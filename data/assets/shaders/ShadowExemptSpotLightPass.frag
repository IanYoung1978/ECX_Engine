...
// this spot light. Trimmed copy of SpotlightShadowPBR.frag with computeOcclusion/shadowMap
// removed - visibility is implicitly 1.0. Paired with shadow.vert (a bare MVP transform, no
// varyings), so sampling uses screen-space texelFetch instead of a full-screen-quad UV
// varying - correct here since this pass draws real mesh geometry.
