...
void EC_LuaScriptSystem::registerAPI() {
    luabridge::getGlobalNamespace(m_luaState)
        ...
        .addFunction("applyForce", &ScriptAPI::EntityAPI::applyForce)
        .addFunction("applyImpulse", &ScriptAPI::EntityAPI::applyImpulse)
        .addFunction("applyTorque", &ScriptAPI::EntityAPI::applyTorque)
        .addFunction("getMass", &ScriptAPI::EntityAPI::getMass)
        .addFunction("setMass", &ScriptAPI::EntityAPI::setMass)
        .addFunction("getRestitution", &ScriptAPI::EntityAPI::getRestitution)
        .addFunction("setRestitution", &ScriptAPI::EntityAPI::setRestitution)
        .addFunction("getFriction", &ScriptAPI::EntityAPI::getFriction)
        ...
        .addFunction("spawnEntity", &ScriptAPI::GameAPI::spawnEntity)
        .addFunction("destroyEntity", &ScriptAPI::GameAPI::destroyEntity)
